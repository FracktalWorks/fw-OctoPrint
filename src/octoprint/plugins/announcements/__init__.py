...
class AnnouncementPlugin(octoprint.plugin.AssetPlugin,
	...
	def get_settings_defaults(self):
		...
		settings = dict(channels=dict(_important=dict(name="Important Announcements",
		                                              ...
		                                              url="https://octoprint.org/feeds/important.xml"),
		                              _releases=dict(name="Release Announcements",
		                                             description="Announcements of new releases and release candidates of fw-OctoPrint.",
		                                             priority=2,
		                                             type="atom",
		                                             url="https://github.com/FracktalWorks/fw-OctoPrint/releases.atom"),
		                              _blog=dict(name="Fracktal Works Blog",
		                                         description="Development news, community spotlights and more from the Fracktal Works Blog.",
		                                         priority=2,
		                                         type="atom",
		                                         url="https://fracktal.in/feed/atom")),
		                enabled_channels=[],
		                forced_channels=["_important"],
		                # channel_order=["_important", "_releases", "_blog", "_plugins", "_octopi"],
		                channel_order=["_important", "_releases", "_blog"],
		                ttl=6*60,
		                display_limit=3,
		                summary_limit=300)
